...
<main id="main-content">
  <div class="bread-crumbs">
    <ul class="clearfix inner">
      ...
      $id=$_GET['id'];
      $_SESSION['id']=$id;
      //select t.*, pl.hyouji_name, pr.fee_hyouji_min,pr.fee_hyouji_max FROM `m_tour` AS t INNER JOIN m_place AS pl ON t.M_PLACE_from_place_id = pl.place_id INNER JOIN m_price as pr ON t.id_tour = pr.id_tour
      // cau lenh chuan cua du an nhu sau
      //select t.*, pl.hyouji_name, pr.fee_hyouji_min,pr.fee_hyouji_max,cp.com_name,cp.license,cp.com_address1,cp.com_address2_bldg,cp.com_tel1 FROM `m_tour` AS t INNER JOIN m_place AS pl ON t.M_PLACE_from_place_id = pl.place_id INNER JOIN m_price as pr ON t.id_tour = pr.id_tour INNER JOIN m_company as cp ON t.com_id = cp.com_id
      //-------------------------------------------------------------------------------------
      //$tv="select sp.*,pl.hyouji_name from san_pham as sp INNER JOIN m_place as pl ON sp.M_PLACE_from_place_id=pl.place_id where id='$id'";
      ...
      echo "<div class='summary-txt-area'>";
        ...
        echo "<table>";
          ...
          echo "<tr>";
            echo "<th>料金</th>";
            //dinh dang gia tien
            $fee_min = $tv_2['fee_min'];
            $fee_min=number_format($fee_min,0,",",",");
            $fee_max = $tv_2['fee_max'];
            $fee_max=number_format($fee_max,0,",",",");                            
            echo "<td>".$fee_min."～".$fee_max."円/1台</td>";
          ...
          <div class="calendar-detail-wrap-in">
            <div class="calendar-detail-box">
              ...
              <dl class="calendar-detail-place">
                乗車場所:
        <input type="text" id="txtSource_1" value="<?php echo $_SESSION['start']; ?>" style="width: 200px" readonly>
               
              </dl>
              <dl class="calendar-detail-place">
                 降車場所:
        <input type="text" id="txtDestination_1" value="<?php echo $_SESSION['end']; ?>" style="width: 200px" readonly>
          ...
          <div class="detail-btn-area-submit">
            <ul>
              ...
              <li>
                ...
                <?php
                //$link_confirm="http://localhost/airport-tourisum/pickup-taxi-confirm/?thamso=confirm_taxi&id=".$id;
                //echo "<a href='$link_confirm'>このプランを申し込む</a>";
                ?>
                <p>このプランを申し込む</p>
              </li>
            </ul>
