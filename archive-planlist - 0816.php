                      ...
                      echo "<div class='plan-list-in-text'>";
                        ...
                        echo "<div class='clearfix'>";
                          echo "<ul class='plan-list-flag'>";
                            ...
                            echo "<li>".$fee_min."～".$fee_max."円 / 1台</li>";
                          echo "</ul>";
...
{   
  ...
  if(trim($_GET['keyword'])!="")
  {
    ...
    $tv="select id, hinh_anh, tour_title,plan_id,noi_dung,to_place,div_1,div_2,fee_min,fee_max,date_txt,number_min from san_pham where $chuoi_tim_sql_2 or $chuoi_tim_sql1_2 order by id desc limit $vtbd,$so_du_lieu";
    $tv_1=mysql_query($tv);
