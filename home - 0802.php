...
while ($tv_2=mysql_fetch_array($tv_1))
...

  {
     ...
     $link_chi_tiet="http://localhost/airport-tourisum/pickup-taxi/?thamso=chi_tiet_tour&id=".$tv_2['id'];
...
<?php
//$tv="select id, hinh_anh from san_pham where level = '997' order by id desc limit 10";
$tv="select id, hinh_anh, tour_title,plan_id,noi_dung,to_place,div_2,fee_min,fee_max from san_pham where level = '997' order by id desc limit 10";
$tv_1= mysql_query($tv);
while ($tv_2=mysql_fetch_array($tv_1))
              ...
              echo "<div class='plan-list-in right'>";
               ...
               /* echo "成田国際空港から東京23区東部エリアへの送迎プランです。";
                ...
                echo "<ul class='plan-list-flag'>";
                  ...
                  echo $tv_2['fee_min']."～".$tv_2['fee_max']."円 / 1台";
                  echo "</li>";
                echo "</ul>";
              echo "</div>";
            echo "</div>";
