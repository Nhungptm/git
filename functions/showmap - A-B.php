...
<script type="text/javascript">
    ...
    function GetRoute() {     // route la lo trinh
        ...
        //console.log(directions); lenh debug nay show ra giá trị của tất cả các loại dữ liệu như number, integer, array, object    
         ...
         //lay diem cuoi
         document.getElementById('end_adr').value = directions.routes[0].legs[directions.routes[0].legs.length-1].end_address;
         var a7=document.getElementById('end_adr').value;         
          document.getElementById("end_adr").innerHTML=a7;
...
<!--                 <div id="dvMap" style="width: 700px; height: 500px"></div>  
 -->                <div id="dvMap" style="width: 1350px; height: 500px"></div>               
            </td>           
        </tr>
      </table>
    </div>
