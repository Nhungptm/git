  ...
  else
  {
    ...
    if ($_GET['keyword_']=="") 
    {
      ...
      if($_GET['date']=="")
      {
        ...
        $so_du_lieu=10;
        //$tv="select count(*) from m_tour where (div_1='空港送迎') AND (entry_limit <= 5)";
        //$tv="select count(*) from m_tour where (div_1='空港送迎') AND (entry_limit <= 5) AND (((M_PLACE_from_place_id =1) and (M_PLACE_to_place_id =5)) or ((M_PLACE_from_place_id =5) and (M_PLACE_to_place_id =1)))";
        $tv="select count(*) from m_tour inner join m_price on m_tour.id_tour=m_price.id_tour where (div_1='空港送迎') AND (div_2='空港送迎') AND (entry_limit <='$day') AND (((M_PLACE_from_place_id ='$airport') and (M_PLACE_to_place_id ='$place2')) or ((M_PLACE_from_place_id ='$place2') and (M_PLACE_to_place_id ='$airport')))";
        $tv_1= mysql_query($tv);
        $tv_2=mysql_fetch_array($tv_1);
        $row_count=$tv_2[0];
        ...
        //$tv = "select id, tour_pic1, tour_name,plan_id, tour_explanation,to_place,div_2,fee_hyouji_min,fee_hyouji_max,date_txt,number_min from m_tour where (div_1='空港送迎') AND (entry_limit <= 5) order by id desc limit $vtbd,$so_du_lieu";
        //$tv = "select id, tour_pic1, tour_name,plan_id, tour_explanation,to_place,div_2,fee_hyouji_min,fee_hyouji_max,date_txt,number_min from m_tour where (div_1='空港送迎') AND (entry_limit <= 5) AND (((M_PLACE_from_place_id =1) and (M_PLACE_to_place_id =5)) or ((M_PLACE_from_place_id =5) and (M_PLACE_to_place_id =1))) order by id desc limit $vtbd,$so_du_lieu";
        $tv = "select m_tour.id_tour,com_id, tour_pic1, tour_title,plan_id, tour_explanation,to_place,div_2,fee_hyouji_min,fee_hyouji_max,date_txt,number_min from m_tour inner join m_price on m_tour.id_tour=m_price.id_tour where (div_1='空港送迎') AND (div_2='空港送迎') AND (entry_limit <= '$day') AND (((M_PLACE_from_place_id = '$airport') and (M_PLACE_to_place_id = '$place2')) or ((M_PLACE_from_place_id = '$place2') and (M_PLACE_to_place_id = '$airport'))) order by m_tour.id_tour desc limit $vtbd,$so_du_lieu";
        $tv_1= mysql_query($tv);
                      ...
                      echo "<div class='plan-list-in-text'>";
                        ...
                        echo "<div class='clearfix'>";
                          echo "<ul class='plan-list-flag'>";
                            ...
                            echo "<li>".$fee_hyouji_min."～".$fee_hyouji_max."円 / 1台</li>";
                          echo "</ul>";
    ...
    if(!isset($_GET['place']))
    {
      ...
      ///////////////////////
        if($_GET['date']=="")
        {
          ...
          // sau khi co duoc 4 cai OK roi, ta tien hanh truy van va show du lieu
          $so_du_lieu=10;
          // luu y truong hop tim kiem TOUR thi can lua chon div_2 nen ta biet div_1 luon luon = ツアー nen ta ko can dua vao dieu kien where.
          $tv="select count(*) from m_tour inner join m_price on m_tour.id_tour=m_price.id_tour where (div_2='$category') AND (entry_limit <= $day) AND (M_PLACE_from_place_id ='$airport') AND (M_PLACE_to_place_id in (SELECT `place_id`FROM `m_place` WHERE `prf`='$place'))";
          //$tv="select count(*) from m_tour where (div_1='空港送迎') AND (entry_limit <= 5) AND (((M_PLACE_from_place_id =1) and (M_PLACE_to_place_id =5)) or ((M_PLACE_from_place_id =5) and (M_PLACE_to_place_id =1)))";
          //$tv="select count(*) from m_tour where (div_1='空港送迎') AND (entry_limit <='$day') AND (((M_PLACE_from_place_id ='$airport') and (M_PLACE_to_place_id ='$place2')) or ((M_PLACE_from_place_id ='$place2') and (M_PLACE_to_place_id ='$airport')))";
          $tv_1= mysql_query($tv);
          $tv_2=mysql_fetch_array($tv_1);
          $row_count=$tv_2[0];
          $so_trang=ceil($tv_2[0]/$so_du_lieu);
          ...
          $tv = "select m_tour.id_tour, tour_pic1, tour_title,plan_id, tour_explanation,to_place,div_2,fee_hyouji_min,fee_hyouji_max,date_txt,number_min from m_tour inner join m_price on m_tour.id_tour=m_price.id_tour where (div_2='$category') AND (entry_limit <= $day) AND (M_PLACE_from_place_id ='$airport') AND (M_PLACE_to_place_id in (SELECT `place_id`FROM `m_place` WHERE `prf`='$place')) order by m_tour.id_tour desc limit $vtbd,$so_du_lieu";
          //$tv = "select id, tour_pic1, tour_name,plan_id, tour_explanation,to_place,div_2,fee_hyouji_min,fee_hyouji_max,date_txt,number_min from m_tour where (div_1='空港送迎') AND (entry_limit <= 5) AND (((M_PLACE_from_place_id =1) and (M_PLACE_to_place_id =5)) or ((M_PLACE_from_place_id =5) and (M_PLACE_to_place_id =1))) order by id desc limit $vtbd,$so_du_lieu";
          //$tv = "select id, tour_pic1, tour_name,plan_id, tour_explanation,to_place,div_2,fee_hyouji_min,fee_hyouji_max,date_txt,number_min from m_tour where (div_1='空港送迎') AND (entry_limit <= '$day') AND (((M_PLACE_from_place_id = '$airport') and (M_PLACE_to_place_id = '$place2')) or ((M_PLACE_from_place_id = '$place2') and (M_PLACE_to_place_id = '$airport'))) order by id desc limit $vtbd,$so_du_lieu";
          $tv_1= mysql_query($tv);
          // khi lay data, dong dau tien duoc tinh la dong thu [0], nhung khi dem data thi dong dau tien la dong thu 1.
          $lay_tu_row_thu=$vtbd+1;
          if($_GET['trang']==$so_trang)
                      ...
                      echo "<div class='plan-list-in right'>";
                        echo "<div class='plan-list-in-text'>";
                          ...
                          echo "<div class='clearfix'>";
                            ...
                            $fee_hyouji_max=number_format($fee_hyouji_max,0,",",",");
                            echo "<li>".$fee_hyouji_min."～".$fee_hyouji_max."円 / 1台</li>";
                              //echo "<li>".$tv_2['fee_hyouji_min']."～".$tv_2['fee_hyouji_max']."円 / 1台</li>";
                            echo "</ul>";
                            echo "<dl class='plan-list-caut clearfix'>";
                              echo "<dt>実施期間</dt>";
                              echo "<dd>".$tv_2['date_txt']."</dd>";
...
{   
  ...
  if(trim($_GET['keyword'])!="")
  {
    ...
    ////    
    $so_du_lieu=10;
    $tv="select count(*) from m_tour inner join m_price on m_tour.id_tour=m_price.id_tour where $chuoi_tim_sql_2 or $chuoi_tim_sql1_2";
    $tv_1=mysql_query($tv);
    $tv_2=mysql_fetch_array($tv_1);
    $row_count=$tv_2[0];
    $so_trang=ceil($tv_2[0]/$so_du_lieu);
    ...
    if(!isset($_GET['trang']))
    ...
    else
      {
        ...
        /////////////////////////////////////
        //$tv="select id,tour_explanation,gia,tour_pic1,thuoc_menu from m_tour where $chuoi_tim_sql_2 order by id desc limit $vtbd,$so_du_lieu";
    $tv="select m_tour.id_tour, tour_pic1, tour_title,plan_id, tour_explanation,to_place,div_1,div_2,fee_hyouji_min,fee_hyouji_max,date_txt,number_min from m_tour inner join m_price on m_tour.id_tour=m_price.id_tour where $chuoi_tim_sql_2 or $chuoi_tim_sql1_2 order by m_tour.id_tour desc limit $vtbd,$so_du_lieu";
    $tv_1=mysql_query($tv);
...
{
  $so_du_lieu=10;
  $tv="select count(*) from m_tour inner join m_price on m_tour.id_tour=m_price.id_tour";
  $tv_1= mysql_query($tv);
  $tv_2=mysql_fetch_array($tv_1);
  $row_count=$tv_2[0];
  $so_trang=ceil($tv_2[0]/$so_du_lieu);
  ...
  $tv="select m_tour.id_tour, tour_pic1, tour_title,plan_id, tour_explanation,to_place,div_1,div_2,fee_hyouji_min,fee_hyouji_max,date_txt,number_min from m_tour inner join m_price on m_tour.id_tour=m_price.id_tour order by m_tour.id_tour desc limit $vtbd,$so_du_lieu";
  $tv_1= mysql_query($tv);
  // khi lay data, dong dau tien duoc tinh la dong thu [0], nhung khi dem data thi dong dau tien la dong thu 1.
  $lay_tu_row_thu=$vtbd+1;
  if($_GET['trang']==$so_trang)
