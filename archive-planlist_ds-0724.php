              ...
              <div class="plan-list-in right">
                <div class="plan-list-in-text">
                  ...
                  <div class="clearfix">
                    ...
                    <dl class="plan-list-caut clearfix">
                      <dt>実施期間</dt>
                      <dd>通年</dd>
                      <dt>最少催行人数</dt>
                      <dd>1名様</dd>
        ...
        <article>
            ...
            <div class="clearfix">
              ...
              <div class="plan-list-in right">
                ...
                <a href="<?php bloginfo('url'); ?>/tour-bus" class="plan-list-more">プラン詳細を見る</a>
              </div>
            </div>
        </article>
        ...
        <article>
            ...
            <div class="clearfix">
              ...
              <div class="plan-list-in right">
                ...
                <a href="<?php bloginfo('url'); ?>" class="plan-list-more">プラン詳細を見る</a>
              </div>
            </div>
        </article>
