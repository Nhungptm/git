...
<main id="main-content">
  <div class="bread-crumbs">
    <ul class="clearfix inner">
      ...
      <li>【成田空港定額タクシー】 成田空港⇒東京23区Ａゾーン</li>
    </ul>
  </div>
      ...
      echo "<div class='summary-txt-area'>";
        ...
        echo "<table>";
          ...
          echo "<tr>";
            ...
            echo "<td>".$tv_2['fee_min']."～".$tv_2['fee_max']."円/1台</td>";
  ...
  <div class="pickup-taxi-info wrap">
    <section class="pickup-taxi-content-in inner">
      ...
      <div class="calendar-detail-area clearfix">
        <form class="calendar-detail-wrap">
          <div class="calendar-detail-wrap-in">
            <div class="calendar-detail-box">
              ...
              <dl class="calendar-detail-place">
                <dt>降車場所（必須）</dt>
                <dd><input type="text" name="name" placeholder="住所を入力"></dd>
              </dl>
            </div>
                  ...
                  <ul>
                    <li>
                      <label>
                        ...
                        <p class="option-parts">チャイルドシート（無料）</p>
                      </label>
                    </li>
                    <li>
                      <label>
        ...
        <div class="calendar-detail-map-area">
          <p>ここにマップを埋め込む</p>
        </div>
