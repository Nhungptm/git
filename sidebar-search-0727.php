                  ...
                  <dd>
                    <select id="airport" name="airport">
                     ...
                     <!--  <option value="成田空港">成田空港</option>
                      ...
                      <option value="22318" <?php if(isset($_GET['airport']) && $_GET['airport'] == 成田空港) {?> selected="selected" <?php } ?>>成田空港</option>
                      <option value="16993" <?php if(isset($_GET['airport']) && $_GET['airport'] == 羽田空港) {?> selected="selected" <?php } ?>>羽田空港</option>
